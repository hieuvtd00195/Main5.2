...
void CUIChatWindow::Init(const wchar_t* pszTitle, DWORD dwParentID)
{
    ...
    //	m_PalListBox.AddText(L"À̀¸§³×ÀÚ", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§³ËÀÚ", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§¼ö³Ư", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§1ÀÚ", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§2ÀÚ", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§3³Ư", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§4ÀÚ", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§5ÀÚ", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§6³Ư", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§7³Ư", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§8³Ư", 1, 1);
    //	m_PalListBox.AddText(L"À̀¸§9³Ư", 1, 1);
...
void CUIChatWindow::ConnectToChatServer( wchar_t* pszIP, DWORD dwRoomNumber, DWORD dwTicket)
{
...
void CUILetterWriteWindow::InitControls()
{
    ...
    m_TitleInputBox.SetTextLimit(MAX_CHATROOM_TEXT_LENGTH - 1);
...
BOOL CUIFriendListTabWindow::HandleMessage()
{
    ...
    case UI_MESSAGE_YNRETURN:
        ...
        {
            if (GetCurrentSelectedFriend() == NULL) break;
            SendRequestDeleteFriend(const_cast<wchar_t*>(GetCurrentSelectedFriend()));
            //RemoveFriend((wchar_t *)GetCurrentSelectedFriend());
        }
        break;
    default:
        break;
...
BOOL CChatRoomSocketList::AddChatRoomSocket(DWORD dwRoomID, DWORD dwWindowUIID, wchar_t* pszIP)
{
    ...
    if (pCRSocket->m_WSClient.Connect(pszIP, usPort, WM_CHATROOMMSG_BEGIN + dwSocketID) == FALSE)
    {
        assert(!"RemoveChatRoomSocket Connect!!!");
        delete pCRSocket;  // Giải phóng bộ nhớ nếu kết nối không thành công
        return FALSE;
    }
